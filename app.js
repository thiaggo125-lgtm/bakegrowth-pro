document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ELEMENTOS */
  const todayPost = document.getElementById("todayPost");
  const story = document.getElementById("story");
  const reelIdea = document.getElementById("reelIdea");
  const storyPro = document.getElementById("storyPro");
